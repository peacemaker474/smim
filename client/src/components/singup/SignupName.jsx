...
function SignupName ({message, setMessage, valid, setValid, handleInputChange}) {
  ...
  return (
    ...
    <SignupTitle> 닉네임 </SignupTitle>
      <SignupInput type="text" name="nickName" onChange={handleInputChange} onBlur={handleBlurName} />
